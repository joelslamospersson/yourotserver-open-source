...
# ────────────────────────── Config ──────────────────────────
# Build TFS 8.0 using vcpkg-based workflow
# Keep cached source zip (for Nekiro downgrades)
CACHE_URL="http://cache.yourotserver.com/cache/TFS-1.5-Downgrades-8.0.zip"
ZIP_NAME="TFS-1.5-Downgrades-8.0.zip"
SRC_DIR_NAME="TFS-1.5-Downgrades-8.0"   # how the zip extracts
...
LOG_FILE="${APP_HOME:-${HOME:-/root}}/nekiro_setup_80.log"
